                                ...
                                <div id="div_danhmuc_dong_kieudang">
                                    ...
                                    <div id="div_dongsanpham">
                                        ...
                                        <select id="select_dongsanpham" name="select_dongsanpham">
                                            <option value="Basas" <?php if ($dong == 'Basas') echo ' selected="selected"'; ?>>Basas</option>
                                            <option value="Vintas" <?php if ($dong == 'Vintas') echo ' selected="selected"'; ?>>Vintas</option>
                                            <option value="Urbas" <?php if ($dong == 'Urbas') echo ' selected="selected"'; ?>>Urbas</option>
                                            <option value="Pattas" <?php if ($dong == 'Pattas') echo ' selected="selected"'; ?>>Pattas</option>
                                            <option value="Creas" <?php if ($dong == 'Creas') echo ' selected="selected"'; ?>>Creas</option>
                                            <option value="Track 6" <?php if ($dong == 'Track 6') echo ' selected="selected"'; ?>>Track 6</option>
                                        </select>
                                    </div>
                                    <br>
                                    <div id="div_kieudang">
                                        ...
                                        <select id="select_kieudang" name="select_kieudang">
                                            <option value="Low Top" <?php if ($dong == 'Low Top') echo ' selected="selected"'; ?>>Low Top</option>
                                            <option value="High Top"<?php if ($dong == 'High Top') echo ' selected="selected"'; ?>>High Top</option>
                                            <option value="Mid Top"<?php if ($dong == 'Mid Top') echo ' selected="selected"'; ?>>Mid Top</option>
                                            <option value="Mule"<?php if ($dong == 'Mule') echo ' selected="selected"'; ?>>Mule</option>
                                        </select>
                                    </div>
                                </div>
                                <br>
