                    ...
                    <div id="div_sua_danhmuc_dong_kieudang">
                        ...
                        <div id="div_sua_dongsanpham">
                            ...
                            <select id="select_sua_dongsanpham" name="select_sua_dongsanpham">
                                <?php if ($row['tendongsp'] == "Basas") {
                                ?>
                                    <option value="Basas" name="basas" selected>Basas</option>
                                ...
                                <?php
                                } else if ($row['tendongsp'] == "Vintas") {
                                ?>
                                    <option value="Basas" name="basas">Basas</option>
                                    <option value="Vintas" name="vintas" selected>Vintas</option>
                                    <option value="Urbas" name="urbas">Urbas</option>
                                    <option value="Pattas" name="pattas">Pattas</option>
                                    <option value="Creas" name="creas">Creas</option>
                                    <option value="Track 6" name="track6">Track 6</option>
                                <?php
                                } else if ($row['tendongsp'] == "Urbas") {
                                ?>
                                    <option value="Basas" name="basas">Basas</option>
                                    <option value="Vintas" name="vintas">Vintas</option>
                                    <option value="Urbas" name="urbas" selected>Urbas</option>
                                    <option value="Pattas" name="pattas">Pattas</option>
                                    <option value="Creas" name="creas">Creas</option>
                                    <option value="Track 6" name="track6">Track 6</option>
                                <?php
                                } else if ($row['tendongsp'] == "Pattas") {
                                ?>
                                    <option value="Basas" name="basas">Basas</option>
                                    <option value="Vintas" name="vintas">Vintas</option>
                                    <option value="Urbas" name="urbas">Urbas</option>
                                    <option value="Pattas" name="pattas" selected>Pattas</option>
                                    <option value="Creas" name="creas">Creas</option>
                                    <option value="Track 6" name="track6">Track 6</option>
                                <?php
                            ...
                            <td>
                                <div id="div_sua_upload_anh_1">
                                    ...
                                    <div id="div_sua_hienthi_anh1">
                                        <img src="../../../uploads/<?php echo $row['img1'] ?> " alt="<?php echo $row['img1'] ?>" style="width: 270px;height: 180px;">
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div id="div_sua_upload_anh_2">
                                    ...
                                    <div id="div_sua_hienthi_anh2">
                                        <img src="../../../uploads/<?php echo $row['img2'] ?>" alt="<?php echo $row['img1'] ?>" style="width: 270px;height: 180px;">
                                    </div>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td>
                                <div id="div_sua_upload_anh_3">
                                    ...
                                    <div id="div_sua_hienthi_anh3">
                                        <img src="../../../uploads/<?php echo $row['img3'] ?>" alt="<?php echo $row['img1'] ?>" style="width: 270px;height: 180px;">
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div id="div_sua_upload_anh_4">
                                    ...
                                    <div id="div_sua_hienthi_anh4"><img src="../../../uploads/<?php echo $row['img4'] ?>" alt="<?php echo $row['img1'] ?>" style="width: 270px;height: 180px;"></div>
                                </div>
