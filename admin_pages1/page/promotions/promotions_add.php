                    ...
                    <div class="error"></div>
                        ...
                        <div id="div_promotion_select_dongsanpham" name="div_promotion_select_dongsanpham">
                            ...
                            <select id="select_khuyenmai_dongsanpham" name="select_khuyenmai_dongsanpham">
                                <option name="basas" value="Basas">Basas</option>
                                <option name="vintas" value="Vintas">Vintas</option>
                                <option name="urbas" value="Urbas">Urbas</option>
                                <option name="pattas" value="Pattas">Pattas</option>
                                <option name="creas" value="Creas">Creas</option>
                                <option name="track6" value="Track 6">Track 6</option>
                            </select>
                        </div>
                    </div>
                </div>
