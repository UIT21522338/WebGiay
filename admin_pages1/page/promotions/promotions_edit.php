                    ...
                    <div class="div_promotions_add_2" style="margin-top: 80px">
                        ...
                        <div id="div_promotion_select_dongsanpham" name="div_promotion_select_dongsanpham">
                            ...
                            <select id="select_sua_khuyenmai_dongsanpham" name="select_sua_khuyenmai_dongsanpham" style="<?php echo ($row['loaisp'] != "") ? "display:block" : "display:none"; ?>">
                                <?php if ($row['loaisp'] != "") { ?>
                                    <option name="basas" value="Basas" <?php echo ($row['loaisp'] == "Basas") ? 'selected' : ''; ?>>Basas</option>
                                    <option name="vintas" value="Vintas" <?php echo ($row['loaisp'] == "Vintas") ? 'selected' : ''; ?>>Vintas</option>
                                    <option name="urbas" value="Urbas" <?php echo ($row['loaisp'] == "Urbas") ? 'selected' : ''; ?>>Urbas</option>
                                    <option name="pattas" value="Pattas" <?php echo ($row['loaisp'] == "Pattas") ? 'selected' : ''; ?>>Pattas</option>
                                    <option name="creas" value="Creas" <?php echo ($row['loaisp'] == "Creas") ? 'selected' : ''; ?>>Creas</option>
                                    <option name="track6" value="Track6" <?php echo ($row['loaisp'] == "Track 6") ? 'selected' : ''; ?>>Track 6</option>
                                <?php } ?>
                            </select>
                        </div>
