    ...
    <nav class="header-navbar-nm" id="navbarSecond">
        <div class="header-container header-container-nm mainmenu">
            <div class="logo logo-nm">
                <a href="index.php"><img src="img/img_homepage/logo.png" alt="Logo"></a>
            </div>
            <div class="menu menu-nm">
                <ul class="navbar-nav-menu navbar-nav-menu-nm">
                    <li class="nav-item nav-item-nm">
                        <a href="index.php?quanly=danhmucsanpham&id=1" class="btn-nav-link btn-nav-link-nm" style="text-decoration: none;">New & Featured</a>
                    </li>
                    <li class="nav-item nav-item-nm">
                    ...
                    <li class="nav-item nav-item-nm">
                        <a href="index.php?quanly=danhmucsanpham&id=4" class="btn-nav-link btn-nav-link-nm" style="text-decoration: none;">SALE OFF</a>
                    </li>
                </ul>
            </div>
