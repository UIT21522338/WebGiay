                    ...
                    <div class="container row-menu-under row-menu-kieudangsanpham">
                        ...
                        <div id="demo2" class="collapse show">
                            <ul class="status-item">
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=17">Low Top</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=18">High Top</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=19">Mid Top</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=20">Mule</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row left-row-item">
                    <div class="container row-menu-under row-menu-dongsanpham">
                        ...
                        <div id="demo" class="collapse show">
                            <ul class="status-item">
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=5">Basas</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=6">Vintas</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=7">Urbas</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=8">Pattas</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=9">Creas</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=10">Track 6</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row left-row-item">
                    <div class="container row-menu-under row-menu-giasanpham" style="width: 100%;">
                        ...
                        <div id="demo1" class="collapse show" style="width: 100%;">
                            <ul class="status-item">
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=11">≥ 600k</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=12">500k - 599k</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=13">400k - 499k</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=14">300k - 399k</a></li>
                                <li><a class="ajax-link" href="index.php?quanly=danhmucsanpham&id=15">200k - 299k</a></li>
